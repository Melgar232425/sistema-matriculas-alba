    ...
    <div style={styles.page} className="premium-dashboard">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .asist-panel-header { flex-direction: column !important; gap: 12px !important; }
          .asist-panel-header > div { width: 100% !important; }
          .asist-save-btn { width: 100% !important; justify-content: center !important; }
          .asist-date-input { width: 100% !important; box-sizing: border-box !important; }
        }
        @media (min-width: 769px) {
          .asist-table { display: table !important; }
          .asist-cards { display: none !important; }
        }
      `}</style>
      ...
      <header style={styles.header}>
        <div style={styles.headerInner}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 15 }}>
            <img src="/logo_oficial.png" alt="Logo Alba" style={{ width: '40px', height: '40px', borderRadius: '10px', objectFit: 'cover', background: 'white', padding: '2px' }} />
            <div>
              <h1 style={{ fontSize: '18px', fontWeight: '900', color: 'white', margin: 0, letterSpacing: '-0.5px' }}>ACADEMIA ALBA</h1>
              <p style={{ fontSize: '10px', color: 'rgba(255,255,255,0.6)', margin: 0, fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px' }}>PORTAL DOCENTE</p>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
            <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontSize: '14px', fontWeight: '800', color: 'white' }}>{user.nombres} {user.apellidos}</span>
              <span style={{ fontSize: '10px', color: '#10b981', fontWeight: '900', textTransform: 'uppercase' }}>● DOCENTE VERIFICADO</span>
            </div>
